...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $localTab = $('<a href="#" id="localImg">' + '本地图片' + '</a>');
        $tabContainer.append($uploadTab).append($linkTab).append($localTab);
        ...
        //本地图片
        var $localContent = $('<div class="content"></div>');
        $contentContainer.append($localContent);
        localContentHandler(editor, menu, $localContent);
        ...
        function tabToggle() {
            ...
            //本地图片
            $localTab.click(function (e) {
                $tabContainer.children().removeClass('selected');
                $contentContainer.children().removeClass('selected');
                $localContent.addClass('selected');
                $localTab.addClass('selected');
                e.preventDefault();
    ...
    // --------------- 处理本地图片content ---------------
    function localContentHandler (edit, menu, $localContent) {
        var lang = editor.config.lang;
        var $urlContainer = $('<div style="margin:20px 10px 10px 10px;"></div>');
        var $urlInput = $('<input id="localInput" type="text" class="block"/>');
        $urlContainer.append($urlInput);
        var $btnSubmit = $('<button id="localButton" class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');

        $localContent.append($urlContainer).append($btnSubmit).append($btnCancel);
          // 取消
        $btnCancel.click(function (e) {
            e.preventDefault();
            menu.dropPanel.hide();
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        editor.commandHooks.lineHeight = function (value) {
          ...
          /*  $(rangeElem).css('line-height', value + '');*/
        };
